          ...
          <Stack spacing={1.25} direction="row" justifyContent="space-between" alignItems="center">
            <Stack direction="row" spacing={1}>
              <Button
                ...
                startIcon={<Image src={masterCard} alt="master card" width={12} height={12} layout="intrinsic" />}
              >
                Card
              </Button>
              <Button
                ...
                startIcon={<Image src={paypal} alt="paypal" width={12} height={12} layout="intrinsic" />}
              >
                Paypal
              </Button>
            </Stack>
