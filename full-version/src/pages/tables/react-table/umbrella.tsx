            ...
            <TableBody {...getTableBodyProps()} className="striped">
              {headerGroups.map((group: HeaderGroup<{}>, index: number) => (
                <TableRow {...group.getHeaderGroupProps()} key={index}>
                  {group.headers.map((column: HeaderGroup, i) => (
                  ...
                  return (
                    ...
                    >
                      {row.cells.map((cell: Cell, index) => {
                        ...
                        return (
                          <TableCell {...cell.getCellProps([{ className: cell.column.className }])} key={index} sx={{ bgcolor }}>
                            {cell.isGrouped ? (
            ...
            <TableFooter sx={{ borderBottomWidth: 2 }}>
              {footerGroups.map((group, index) => (
                <TableRow {...group.getFooterGroupProps()} key={index}>
                  {group.headers.map((column: HeaderGroup, i) => (
                    <TableCell {...column.getFooterProps([{ className: column.className }])} key={i}>
      ...
      [
        ...
        },
        {
          ...
          Cell: ({ value }: { value: number }) => (
            <Avatar alt="Avatar 1" size="sm" src={`/assets/images/users/avatar-${!value ? 1 : value}.png`} />
          )
        },
        {
          Header: 'First Name',
...
UmbrellaTable.getLayout = function getLayout(page: ReactElement) {
